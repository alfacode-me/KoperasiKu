<!-- Main App KoperasiKu -->
<html ng-app="koperasiku" ng-controller="jenis_simpanan">
<!-- Head [FIX]-->
<head>
  <meta charset="utf-8">
  ...
  <div class="ui container">
    <div class="ui segments title">
      ...
      <div class="ui top attached inverted violet menu kpr-menu">
        ...
        <a ng-click="refresh()" ng-href="/jenis_simpanan" class="active item">
      ...
      <div class="ui segment">
          ...
          <div class="ui form">
            <div class="four fields">
              <div class="field">
                ...
                <input name="nama" ng-model="jenis_simpanan.jns_simpanan" class="ui input kpr" type="text">
              </div>
              <div class="field">
                <label>Bunga (%)</label>
                <input name="bunga" ng-model="jenis_simpanan.bunga_simpanan" class="ui input kpr" type="text">
              </div>
              <div class="field">
              </div>
              <div class="field">
            ...
            <div class="four fields">
              ...
              <div class="field">
                <div class="ui right floated buttons">
                  ...
                  <div ng-click="tambah_jenis_simpanan()" class="ui animated fade right floated violet submit button" tabindex="0">
        ...
        <div id="ubah" class="ui large modal">
          <div class="header">
            Mengubah Data Jenis Simpanan @{{update.id_jns_simpanan}}
          </div>
          <div class="content">
            <div class="ui form">
              <div class="four fields">
                <div class="field">
                  <label>Nama Jenis Simpanan</label>
                  <input name="nama" ng-model="update.jns_simpanan" class="ui input kpr" type="text">
                </div>
                <div class="field">
                  <label>Bunga (%)</label>
                  <input name="bunga" value="@{{update.bunga}}" ng-model="update.bunga_simpanan" class="ui input kpr" type="text">
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="rinci" class="ui basic modal">
          ...
          <div class="header">
            Rincian Data Jenis Simpanan @{{rincian.id_jns_simpanan}}
          </div>
          <div class="image content">
            ...
            <div class="description">
              <div class="ui form">
                <div class="fields">
                  <div class="field">
                    <h4>ID Jenis Simpanan</h4>
                    <h4>Nama Simpanan</h4>
                    <h4>Bunga</h4>
                    <h4>Terakhir di Update</h4>
                  </div>
                  <div class="field">
                    <h4>: @{{rincian.id_jns_simpanan}}</h4>
                    <h4>: @{{rincian.jns_simpanan}}</h4>
                    <h4>: @{{rincian.bunga_simpanan}} %</h4>
        ...
        <div id="hapus" class="ui basic modal">
          <i class="close icon"></i>
          <div class="header">
            Menghapus Data Jenis Simpanan @{{delete.id_jns_simpanan}}
          </div>
          <div class="image content">
            <div class="image">
            ...
            <div class="description">
              <p>Apakah Anda yakin akan menghapus data jenis simpanan <b>@{{delete.id_jns_simpanan}}</b> ?</p>
        ...
        <div class="ui attached segment">
              ...
              <div class="eight wide field">
                <div class="ui group input">
                  <select ng-model="order" dropdown class="ui small dropdown">
                    ...
                    <option value="id_jns_simpanan">Id Jenis Simpanan</option>
                    <option value="jns_simpanan">Nama Jenis Simpanan</option>
                    <option value="bunga_simpanan">Bunga</option>
                  </select>
          ...
          <table class="ui selectable inverted violet celled small striped table">
            <thead ng-if="hasil.length != 0">
              <tr>
                <th class="center aligned">Id Jenis Simpanan</th>
                <th class="center aligned">Nama Jenis Simpanan</th>
                <th class="center aligned">Bunga</th>
                <th class="center aligned">Operasi</th>
              </tr>
            </thead>
            <tbody ng-init="n=0">
              <tr ng-repeat="jss in js | limitTo: dtmax: n | orderBy:order:urut | filter:cari as hasil">
                <td>@{{jss.id_jns_simpanan}}</td>
                <td>@{{jss.jns_simpanan}}</td>
                <td>@{{jss.bunga_simpanan}} %</td>
                <td class="center aligned">
                  <div class="tiny ui icon buttons">
                    <div modalrinci ng-click="pilih(jss)" class="ui icon button">
                      <i class="File Text Outline icon"></i>
                    </div>
                    <div modalubah  ng-click="pilih(jss)" class="ui icon button">
                      <i class="edit icon"></i>
                    </div>
                    <div modalhapus ng-click="pilih(jss)" class="ui icon button">
                      <i class="trash icon"></i>
                    </div>
                  </div>
                </td>
          ...
          <!-- Info Jumlah Data -->
          <h4>Total Data Jenis Simpanan : @{{js.length}} Data, Menampilkan @{{hasil.length}} data</h4>
        </div>
      </div>
      <!-- Footer -->
...
<script src="/dist/controller/jenis_simpanan.js" charset="utf-8"></script>
